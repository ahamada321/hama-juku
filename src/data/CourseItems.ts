...
export const coursePosts: CoursePost[] = [
  ...
  },
  {
    ...
    title: "【出来高分析の決定版】VPA（Volume Price Analysis）",
    excerpt: "出来高/価格帯別出来高/VWAPを学ぶことで、売買判断の再現性を高める",
    benefit: [
      "そもそも出来高とはどういったものなのかを理解できる",
      "出来高分析（VPA）の具体的な手順がわかる",
      "価格帯別出来高を学び、実践トレードに活かす方法がわかる",
      "出来高加重平均価格（VWAP）を実践レベルで使えるようになる",
      "ハマ塾限定「出来高加重ローソク足」インジが手に入る",
      "わからない箇所はいつでも質問可能",
    ],
    image: "/img/va.png",
    salePrice: 49800,
  ...
  },
  {
    slug: "pa",
    publishedDate: "June 20, 2025",
    title: "【相場の流れを読み解く】プライスアクション完全攻略",
    excerpt: "ローソク足の値動きの本質を理解し、再現性ある売買判断を身につける",
    benefit: [
      "プライスアクションについて理解できる",
